...
public class ControlEmpleado implements ActionListener {
    ...
    public ControlEmpleado(Empleados modEmp, MetodosEmpleadosSP metEmp, VistaEmpleadosPrincipal varJfrVistaEmpPrinc, VistaEmpleadosSecundaria jfrVistaEmpSec) {
        ...
        this.varJfrVistaEmpSec.jbCancelar.addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (varJfrVistaEmpPrinc.jbBuscarEmp.equals(ev.getSource())) {
            DefaultTableModel modelo = new DefaultTableModel();
            varJfrVistaEmpPrinc.jtEmpleados.setModel(modelo);
        ...
        if (varJfrVistaEmpPrinc.jbAgregarEmp.equals(ev.getSource())) {
        ...
        if (varJfrVistaEmpPrinc.jbActualizarEmp.equals(ev.getSource())) {
        ...
        if (varJfrVistaEmpSec.jbGuardar.equals(ev.getSource())) {
            
            String varmodempori = varModEmp.getCodigo();
            ...
            try {
                if ("INSERT".equals(accion)) {
                    ...
                    if (varMetEmp.actualizarEmpleado(varmodempori, varModEmp)) {
        ...
        if (varJfrVistaEmpPrinc.jbEliminarEmp.equals(ev.getSource())) {
        ...
        if(varJfrVistaEmpSec.jbCancelar.equals(ev.getSource())){
