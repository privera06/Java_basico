 ...
 * @author Pamela
 */
public class VistaLoginUser extends javax.swing.JFrame {

    /**
     * Creates new form LoginUser
     */
    public VistaLoginUser() {
        initComponents();        
    }
    ...
    private void jbIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbIngresarActionPerformed
        ...
        try {
            ...
            Logger.getLogger(VistaLoginUser.class.getName()).log(Level.SEVERE, null, ex);
        }      
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaLoginUser().setVisible(true);
            }
        });
    }
